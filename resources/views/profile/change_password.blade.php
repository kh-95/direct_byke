...
<div id="changePasswordModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id='changePasswordForm' action="{{route('forget.password.get')}}">
                ...
                <div class="modal-body">
                    ...
                    {{csrf_field()}}<div class="row">
                        <div class="form-group col-sm-12">
                            <label>{{trans('validation.current_password')}}:</label><span
                        ...
                        <div class="form-group col-sm-12">
                            <label>{{trans('validation.new_password')}}:</label><span
                                    class="required confirm-pwd"></span><span class="required">*</span>
                            <div class="input-group">
                        ...
                        <div class="form-group col-sm-12">
                            <label>{{trans('validation.password_confirmation')}}:</label><span
                                    class="required confirm-pwd"></span><span class="required">*</span>
                            <div class="input-group">
